...
import com.tbs.circle.utils.DensityUtil;
...
public class SnsPopupWindow extends PopupWindow implements OnClickListener{
	...
	public SnsPopupWindow(Context context) {
        ...
        ll_pl = (LinearLayout) view.findViewById(R.id.ll_pl);
        ll_zan.setOnClickListener(this);
        ll_pl.setOnClickListener(this);

		this.setContentView(view);
		this.setWidth(DensityUtil.dip2px(context, 192));
