package com.tbs.circle.callback;
...
public class ImgMoveCallBack extends ItemTouchHelper.Callback {
    ...
    public ImgMoveCallBack(PostArticleImgAdapter adapter, List<ImageItem> originImages) {
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder target) {
        ...
        if (toPosition == originImages.size() || originImages.size() == fromPosition) {
            return true;
        }
