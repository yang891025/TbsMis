...
public class AudioPresenter implements AudioContract.Presenter
{
    ...
    @Override
    public void setLength(Long content) {
        this.Length = content;
    }
    ...
    public void upLoadAudio() {
        ...
        //拼接参数
        String verifyURL = DatasUtil.URL_PUBLISH_FILE + "?type=audio&userName="+DatasUtil.getUserMsg(view.getBaseContext()).getId()+"&fileName=" + fileName;
    ...
    private void sendSocial() {
        ...
        params.put("location", "");
        params.put("type", "4");
        params.put("imagestr", "audio/"+fileName);
