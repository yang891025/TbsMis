...
public class FlipLoadingLayout extends LoadingLayout {
	...
	public FlipLoadingLayout(Context context, PullToRefreshBase.Mode mode, PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
        ...
        this.mRotateAnimation.setDuration(FlipLoadingLayout.FLIP_ANIMATION_DURATION);
        ...
        this.mResetRotateAnimation.setDuration(FlipLoadingLayout.FLIP_ANIMATION_DURATION);
	...
	protected int getDefaultDrawableResId() {
		return drawable.default_ptr_flip;
	}
