...
public class PullToRefreshWebView2 extends PullToRefreshWebView {
	...
	protected WebView createRefreshableView(Context context, AttributeSet attrs) {
		...
		webView.addJavascriptInterface(this.mJsCallback, PullToRefreshWebView2.JS_INTERFACE_PKG);
	...
	protected boolean isReadyForPullStart() {
		// Call Javascript...
        this.getRefreshableView().loadUrl(PullToRefreshWebView2.DEF_JS_READY_PULL_DOWN_CALL);
	...
	protected boolean isReadyForPullEnd() {
		// Call Javascript...
        this.getRefreshableView().loadUrl(PullToRefreshWebView2.DEF_JS_READY_PULL_UP_CALL);
