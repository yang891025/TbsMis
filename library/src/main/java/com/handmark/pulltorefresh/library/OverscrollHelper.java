...
public final class OverscrollHelper {
	...
	public static void overScrollBy(PullToRefreshBase<?> view, int deltaX, int scrollX,
        ...
        OverscrollHelper.overScrollBy(view, deltaX, scrollX, deltaY, scrollY, scrollRange, 0, OverscrollHelper.DEFAULT_OVERSCROLL_SCALE, isTouchEvent);
	}
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (PullToRefreshBase.DEBUG) {
					Log.d(OverscrollHelper.LOG_TAG, "OverScroll. DeltaX: " + deltaX + ", ScrollX: " + scrollX + ", DeltaY: " + deltaY
