...
public abstract class Connection {
    ...
    static {
        ...
        try {
            Connection.DEBUG_ENABLED = Boolean.getBoolean("smack.debugEnabled");
        }
        catch (Exception e) {
            // Ignore.
        }
    ...
    protected final Map<PacketListener, Connection.ListenerWrapper> recvListeners =
            new ConcurrentHashMap<PacketListener, Connection.ListenerWrapper>();
    ...
    protected final Map<PacketInterceptor, Connection.InterceptorWrapper> interceptors =
            new ConcurrentHashMap<PacketInterceptor, Connection.InterceptorWrapper>();
     ...
     */
    protected final int connectionCounterValue = Connection.connectionCounter.getAndIncrement();
    ...
    public static void addConnectionCreationListener(
        ...
        Connection.connectionEstablishedListeners.add(connectionCreationListener);
    }
    ...
    public static void removeConnectionCreationListener(
            ConnectionCreationListener connectionCreationListener) {
        Connection.connectionEstablishedListeners.remove(connectionCreationListener);
    }
    ...
    protected static Collection<ConnectionCreationListener> getConnectionCreationListeners() {
        return Collections.unmodifiableCollection(Connection.connectionEstablishedListeners);
    }
    ...
    public void addPacketListener(PacketListener packetListener, PacketFilter packetFilter) {
        ...
        Connection.ListenerWrapper wrapper = new Connection.ListenerWrapper(packetListener, packetFilter);
    ...
    protected void firePacketSendingListeners(Packet packet) {
        ...
        for (Connection.ListenerWrapper listenerWrapper : this.sendListeners.values()) {
    ...
    public void addPacketInterceptor(PacketInterceptor packetInterceptor,
        ...
        this.interceptors.put(packetInterceptor, new Connection.InterceptorWrapper(packetInterceptor, packetFilter));
    }
    ...
    protected void firePacketInterceptors(Packet packet) {
        if (packet != null) {
            for (Connection.InterceptorWrapper interceptorWrapper : this.interceptors.values()) {
    ...
    protected static class InterceptorWrapper {
		...
		public boolean equals(Object object) {
            ...
            if (object instanceof Connection.InterceptorWrapper) {
                return ((Connection.InterceptorWrapper) object).packetInterceptor
