...
class NonSASLAuthentication implements UserAuthentication {
	...
	public String authenticate(String username, String password, String resource) throws
        ...
        PacketCollector collector =
                this.connection.createPacketCollector(new PacketIDFilter(discoveryAuth.getPacketID()));
        // Send the packet
	...
	public String authenticateAnonymously() throws XMPPException {
        ...
        PacketCollector collector =
                this.connection.createPacketCollector(new PacketIDFilter(auth.getPacketID()));
        // Send the packet.
        this.connection.sendPacket(auth);
        // Wait up to a certain number of seconds for a response from the server.
        IQ response = (IQ) collector.nextResult(SmackConfiguration.getPacketReplyTimeout());
