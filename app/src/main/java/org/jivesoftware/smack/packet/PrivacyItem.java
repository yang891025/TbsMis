...
public class PrivacyItem {
    ...
    public PrivacyItem(String type, boolean allow, int order) {
        setRule(PrivacyItem.PrivacyRule.fromString(type));
        setAllow(allow);
        setOrder(order);
    }
    ...
    public boolean isFilterEverything() {
		return !(isFilterIQ() || isFilterMessage() || isFilterPresence_in()
	...
	private void setRule(PrivacyItem.PrivacyRule rule) {
		this.rule = rule;
	}
	/**
	...
	public static class PrivacyRule {
         ...
         protected static PrivacyItem.PrivacyRule fromString(String value) {
             ...
             PrivacyItem.PrivacyRule rule = new PrivacyItem.PrivacyRule();
             rule.setType(PrivacyItem.Type.valueOf(value.toLowerCase()));
             return rule;
         }
          ...
          */
         private void setType(PrivacyItem.Type type) {
     		this.type = type;
     	}
         ...
         private void setSuscriptionValue(String value) {
             ...
             if (PrivacyItem.PrivacyRule.SUBSCRIPTION_BOTH.equalsIgnoreCase(value)) {
            	 setValue = PrivacyItem.PrivacyRule.SUBSCRIPTION_BOTH;
             }
             else if (PrivacyItem.PrivacyRule.SUBSCRIPTION_TO.equalsIgnoreCase(value)) {
            	 setValue = PrivacyItem.PrivacyRule.SUBSCRIPTION_TO;
             }
             else if (PrivacyItem.PrivacyRule.SUBSCRIPTION_FROM.equalsIgnoreCase(value)) {
            	 setValue = PrivacyItem.PrivacyRule.SUBSCRIPTION_FROM;
             }
             else if (PrivacyItem.PrivacyRule.SUBSCRIPTION_NONE.equalsIgnoreCase(value)) {
            	 setValue = PrivacyItem.PrivacyRule.SUBSCRIPTION_NONE;
             }
