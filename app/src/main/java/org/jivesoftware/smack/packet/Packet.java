...
public abstract class Packet {
    ...
    private static String DEFAULT_XML_NS;
    ...
    static {
        Packet.XEP_0082_UTC_FORMAT.setTimeZone(TimeZone.getTimeZone("UTC"));
    }
    ...
    private final String xmlns = Packet.DEFAULT_XML_NS;
    ...
    public static synchronized String nextID() {
        return Packet.prefix + Long.toString(Packet.id++);
    }

    public static void setDefaultXmlns(String defaultXmlns) {
        Packet.DEFAULT_XML_NS = defaultXmlns;
    }
    ...
    public String getPacketID() {
        if (Packet.ID_NOT_AVAILABLE.equals(this.packetID)) {
            return null;
        }
    ...
    public static String getDefaultLanguage() {
        return Packet.DEFAULT_LANGUAGE;
    }
	...
	public boolean equals(Object o) {
        ...
        if (this.error != null ? !this.error.equals(packet.error) : packet.error != null) { return false; }
        if (this.from != null ? !this.from.equals(packet.from) : packet.from != null) { return false; }
        if (!this.packetExtensions.equals(packet.packetExtensions)) { return false; }
        if (this.packetID != null ? !this.packetID.equals(packet.packetID) : packet.packetID != null) {
            return false;
        }
        if (this.properties != null ? !this.properties.equals(packet.properties)
                : packet.properties != null) {
            return false;
        }
        if (this.to != null ? !this.to.equals(packet.to) : packet.to != null)  { return false; }
        return !(this.xmlns != null ? !this.xmlns.equals(packet.xmlns) : packet.xmlns != null);
    }

    @Override
	public int hashCode() {
        int result;
        result = this.xmlns != null ? this.xmlns.hashCode() : 0;
