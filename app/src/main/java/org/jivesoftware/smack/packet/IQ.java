...
public abstract class IQ extends Packet {
    ...
    private IQ.Type type = IQ.Type.GET;
    ...
    /**
     * Convenience method to create a new empty {@link IQ.Type#RESULT IQ.Type.RESULT}
     * IQ based on a {@link IQ.Type#GET IQ.Type.GET} or {@link IQ.Type#SET IQ.Type.SET}
     * IQ. The new packet will be initialized with:<ul>
     *      <li>The sender set to the recipient of the originating IQ.
     *      <li>The recipient set to the sender of the originating IQ.
     *      <li>The type set to {@link IQ.Type#RESULT IQ.Type.RESULT}.
     *      <li>The id set to the id of the originating IQ.
     *      <li>No child element of the IQ element.
     * </ul>
     *
     * @param iq the {@link IQ.Type#GET IQ.Type.GET} or {@link IQ.Type#SET IQ.Type.SET} IQ packet.
     * @throws IllegalArgumentException if the IQ packet does not have a type of
     *      {@link IQ.Type#GET IQ.Type.GET} or {@link IQ.Type#SET IQ.Type.SET}.
     * @return a new {@link IQ.Type#RESULT IQ.Type.RESULT} IQ based on the originating IQ.
     */
    ...
    /**
     * Convenience method to create a new {@link IQ.Type#ERROR IQ.Type.ERROR} IQ
     * based on a {@link IQ.Type#GET IQ.Type.GET} or {@link IQ.Type#SET IQ.Type.SET}
     * IQ. The new packet will be initialized with:<ul>
     *      <li>The sender set to the recipient of the originating IQ.
     *      <li>The recipient set to the sender of the originating IQ.
     *      <li>The type set to {@link IQ.Type#ERROR IQ.Type.ERROR}.
     *      <li>The id set to the id of the originating IQ.
     ...
     * @throws IllegalArgumentException if the IQ packet does not have a type of
     *      {@link IQ.Type#GET IQ.Type.GET} or {@link IQ.Type#SET IQ.Type.SET}.
     * @return a new {@link IQ.Type#ERROR IQ.Type.ERROR} IQ based on the originating IQ.
     */
    ...
    public static class Type {
        ...
        public static IQ.Type fromString(String type) {
            ...
            if (IQ.Type.GET.toString().equals(type)) {
                return IQ.Type.GET;
            }
            else if (IQ.Type.SET.toString().equals(type)) {
                return IQ.Type.SET;
            }
            else if (IQ.Type.ERROR.toString().equals(type)) {
                return IQ.Type.ERROR;
            }
            else if (IQ.Type.RESULT.toString().equals(type)) {
