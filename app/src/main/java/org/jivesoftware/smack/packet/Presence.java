 ...
 *      <li>Mode -- one of five presence modes: {@link Presence.Mode#available available} (the default),
 *          {@link Presence.Mode#chat chat}, {@link Presence.Mode#away away}, {@link Presence.Mode#xa xa} (extended away), and
 *          {@link Presence.Mode#dnd dnd} (do not disturb).
 * </ul><p>
 *
...
public class Presence extends Packet {
     ...
     */
    public Presence(Presence.Type type, String status, int priority, Presence.Mode mode) {
        this.setType(type);
    ...
    /**
     * Returns true if the {@link Presence.Type presence type} is available (online) and
     ...
     * when the user is available, their presence mode may be {@link Presence.Mode#away away},
     * {@link Presence.Mode#xa extended away} or {@link Presence.Mode#dnd do not disturb}. Use
    ...
    /**
     * Returns true if the presence type is {@link Presence.Type#available available} and the presence
     * mode is {@link Presence.Mode#away away}, {@link Presence.Mode#xa extended away}, or
     * {@link Presence.Mode#dnd do not disturb}. False will be returned when the type or mode
	...
	public String toXML() {
        ...
        if (this.type != Presence.Type.available) {
        ...
        if (this.mode != null && this.mode != Presence.Mode.available) {
     ...
     * type of {@link #available available}, even if the mode is {@link Presence.Mode#away away},
     * {@link Presence.Mode#dnd dnd}, etc. The presence type is only {@link #unavailable unavailable} when
