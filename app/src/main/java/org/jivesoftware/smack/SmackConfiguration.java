...
public final class SmackConfiguration {
    ...
    private static final Vector<String> defaultMechs = new Vector<String>();
                        ...
                        do {
                            if (eventType == XmlPullParser.START_TAG) {
                                if (parser.getName().equals("className")) {
                                    ...
                                    SmackConfiguration.packetReplyTimeout =
                                            SmackConfiguration.parseIntProperty(parser, SmackConfiguration.packetReplyTimeout);
                                }
                                else if (parser.getName().equals("keepAliveInterval")) {
                                    SmackConfiguration.keepAliveInterval = SmackConfiguration.parseIntProperty(parser, SmackConfiguration.keepAliveInterval);
                                }
                                else if (parser.getName().equals("mechName")) {
                                    SmackConfiguration.defaultMechs.add(parser.nextText());
                                }
                            }
    ...
    public static String getVersion() {
        return SmackConfiguration.SMACK_VERSION;
    }
    ...
    public static int getPacketReplyTimeout() {
        ...
        if (SmackConfiguration.packetReplyTimeout <= 0) {
            SmackConfiguration.packetReplyTimeout = 5000;
        }
        return SmackConfiguration.packetReplyTimeout;
    }
    ...
    public static void setPacketReplyTimeout(int timeout) {
        ...
        SmackConfiguration.packetReplyTimeout = timeout;
    }
    ...
    public static int getKeepAliveInterval() {
        return SmackConfiguration.keepAliveInterval;
    }
    ...
    public static void setKeepAliveInterval(int interval) {
        SmackConfiguration.keepAliveInterval = interval;
    }
    ...
    public static void addSaslMech(String mech) {
        if(!SmackConfiguration.defaultMechs.contains(mech) ) {
            SmackConfiguration.defaultMechs.add(mech);
        }
    }
   ...
   /**
    ...
    public static void removeSaslMech(String mech) {
        if(SmackConfiguration.defaultMechs.contains(mech) ) {
            SmackConfiguration.defaultMechs.remove(mech);
        }
    }
   ...
   /**
    ...
    public static List<String> getSaslMechs() {
        return SmackConfiguration.defaultMechs;
    }
