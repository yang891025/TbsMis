...
/* ********  D E T E R M I N E   W H I C H   A L H A B E T  ******** */
	...
	{
		if( (options & Base64.URL_SAFE) == Base64.URL_SAFE) return Base64._URL_SAFE_ALPHABET;
		else if( (options & Base64.ORDERED) == Base64.ORDERED) return Base64._ORDERED_ALPHABET;
		else return Base64._STANDARD_ALPHABET;
	...
	{
		if( (options & Base64.URL_SAFE) == Base64.URL_SAFE) return Base64._URL_SAFE_DECODABET;
		else if( (options & Base64.ORDERED) == Base64.ORDERED) return Base64._ORDERED_DECODABET;
		else return Base64._STANDARD_DECODABET;
