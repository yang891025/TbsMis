...
public class PacketParserUtils {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (elementName.equals("subject")) {
                    ...
                    message.setError(PacketParserUtils.parseError(parser));
                        ...
                        namespace.equals(PacketParserUtils.PROPERTIES_NAMESPACE))
                {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                if (parser.getName().equals("item")) {
                    ...
                    ItemStatus status = ItemStatus.fromString(ask);
                    item.setItemStatus(status);
                    // Set type.
                    String subscription = parser.getAttributeValue("", "subscription");
                    ItemType type = ItemType.valueOf(subscription != null ? subscription : "none");
    ...
    public static XMPPError parseError(XmlPullParser parser) throws Exception {
        ...
        Type errorType = Type.CANCEL;
        try {
            if (type != null) {
                errorType = Type.valueOf(type.toUpperCase());
            }
        }
        catch (IllegalArgumentException iae) {
            ...
            throws Exception
    {
        ...
        if (provider != null) {
            if (provider instanceof PacketExtensionProvider) {
                ...
                return (PacketExtension) PacketParserUtils.parseWithIntrospection(
