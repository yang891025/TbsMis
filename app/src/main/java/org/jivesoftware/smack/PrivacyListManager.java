...
public class PrivacyListManager {
	...
	private static final Map<Connection, PrivacyListManager> instances = new Hashtable<Connection, PrivacyListManager>();

	private final Connection connection;
	private final List<PrivacyListListener> listeners = new ArrayList<PrivacyListListener>();
	PacketFilter packetFilter = new AndFilter(new IQTypeFilter(Type.SET),
    ...
    private void init() {
        ...
        PrivacyListManager.instances.put(this.connection, this);
    ...
    public PrivacyList[] getPrivacyLists() throws XMPPException {
        ...
        for (String listName : names) {
            ...
            lists[index] = new PrivacyList(isActiveList, isDefaultList,
                    listName, this.getPrivacyListItems(listName));
            index = index + 1;
        }
        return lists;
    }
