...
public class RosterEntry {
     ...
     */
    RosterEntry(String user, String name, ItemType type,
                ItemStatus status, Roster roster, Connection connection) {
        this.user = user;
        this.name = name;
        this.type = type;
        this.status = status;
     ...
     * @param status the subscription status (related to subscriptions pending to be approbed).
     */
    void updateState(String name, ItemType type, ItemStatus status) {
        this.name = name;
        this.type = type;
        this.status = status;
    }
	...
	public String toString() {
        ...
        Collection<RosterGroup> groups = this.getGroups();
        if (!groups.isEmpty()) {
            buf.append(" [");
