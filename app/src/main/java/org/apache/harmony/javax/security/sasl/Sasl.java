...
public class Sasl {
                ...
                if (s.startsWith(service)) {
                    ...
                    try {
                        if (props.add(prName.concat(prop))) {
                            fact.add(Sasl.newInstance(prop, pp[i]));
                        }
    ...
    public static Enumeration<SaslClientFactory> getSaslClientFactories() {
        Collection<SaslClientFactory> res = (Collection<SaslClientFactory>) Sasl.findFactories(Sasl.CLIENTFACTORYSRV);
    ...
    public static Enumeration<SaslServerFactory> getSaslServerFactories() {
        Collection<SaslServerFactory> res = (Collection<SaslServerFactory>) Sasl.findFactories(Sasl.SERVERFACTORYSRV);
        return Collections.enumeration(res);
    }
    ...
    public static SaslServer createSaslServer(String mechanism, String protocol,
        ...
        Collection<?> res = Sasl.findFactories(Sasl.SERVERFACTORYSRV);
        if (res.isEmpty()) {
            return null;
        }
    ...
    public static SaslClient createSaslClient(String[] mechanisms, String authanticationID,
        ...
        Collection<?> res = Sasl.findFactories(Sasl.CLIENTFACTORYSRV);
        if (res.isEmpty()) {
            return null;
        }
