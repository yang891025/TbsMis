...
public final class AuthPermission extends BasicPermission {
    ...
    private static String init(String name) {
        ...
        if (AuthPermission.CREATE_LOGIN_CONTEXT.equals(name)) {
            return AuthPermission.CREATE_LOGIN_CONTEXT_ANY;
        }
        return name;
    }
    ...
    public AuthPermission(String name) {
        super(AuthPermission.init(name));
    }
    ...
    public AuthPermission(String name, String actions) {
        super(AuthPermission.init(name), actions);
    }
}