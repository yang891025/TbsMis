...
public class AppConfigurationEntry {
    ...
    public static class LoginModuleControlFlag {
        ...
        public static final AppConfigurationEntry.LoginModuleControlFlag REQUIRED = new AppConfigurationEntry.LoginModuleControlFlag(
                "LoginModuleControlFlag: required"); //$NON-NLS-1$

        public static final AppConfigurationEntry.LoginModuleControlFlag REQUISITE = new AppConfigurationEntry.LoginModuleControlFlag(
                "LoginModuleControlFlag: requisite"); //$NON-NLS-1$

        public static final AppConfigurationEntry.LoginModuleControlFlag OPTIONAL = new AppConfigurationEntry.LoginModuleControlFlag(
                "LoginModuleControlFlag: optional"); //$NON-NLS-1$

        public static final AppConfigurationEntry.LoginModuleControlFlag SUFFICIENT = new AppConfigurationEntry.LoginModuleControlFlag(
