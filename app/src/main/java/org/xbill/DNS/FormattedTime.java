...
static {
    FormattedTime.w2 = new DecimalFormat();
    FormattedTime.w2.setMinimumIntegerDigits(2);

    FormattedTime.w4 = new DecimalFormat();
    FormattedTime.w4.setMinimumIntegerDigits(4);
...
format(Date date) {
	...
	c.setTime(date);
	sb.append(FormattedTime.w4.format(c.get(Calendar.YEAR)));
	sb.append(FormattedTime.w2.format(c.get(Calendar.MONTH)+1));
	sb.append(FormattedTime.w2.format(c.get(Calendar.DAY_OF_MONTH)));
	sb.append(FormattedTime.w2.format(c.get(Calendar.HOUR_OF_DAY)));
	sb.append(FormattedTime.w2.format(c.get(Calendar.MINUTE)));
	sb.append(FormattedTime.w2.format(c.get(Calendar.SECOND)));
	return sb.toString();
}
