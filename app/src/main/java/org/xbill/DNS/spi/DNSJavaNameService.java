...
protected
DNSJavaNameService() {
	String nameServers = System.getProperty(DNSJavaNameService.nsProperty);
	String domain = System.getProperty(DNSJavaNameService.domainProperty);
	String v6 = System.getProperty(DNSJavaNameService.v6Property);
	...
	if (domain != null) {
		try {
			...
			System.err.println("DNSJavaNameService: invalid " +
                    DNSJavaNameService.domainProperty);
		}
	}

	if ("true".equalsIgnoreCase(v6))
        this.preferV6 = true;
}
