...
public class MenuListAdapter extends BaseAdapter {
	...
	public MenuListAdapter(ArrayList<Map<String, String>> list, Context context) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			holder = new MenuListAdapter.ViewHolder();
			...
			holder = (MenuListAdapter.ViewHolder) convertView.getTag();
		}
