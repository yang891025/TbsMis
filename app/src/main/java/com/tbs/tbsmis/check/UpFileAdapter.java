...
public class UpFileAdapter extends BaseAdapter {
	...
	public UpFileAdapter(List<String> list, Context context) {
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.children_cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(UpFileAdapter.this.isSelected.get(position)){
                    UpFileAdapter.this.isSelected.put(position, false);
                }else{
                    UpFileAdapter.this.isSelected.put(position, true);
                }
