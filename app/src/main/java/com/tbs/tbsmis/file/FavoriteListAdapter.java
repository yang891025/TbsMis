...
public class FavoriteListAdapter extends ArrayAdapter<FavoriteItem> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            view = this.mInflater.inflate(R.layout.favorite_item, parent, false);
        }

        FavoriteItem item = this.getItem(position);
        ...
        if (lFileInfo.ModifiedDate > 0) {
            Util.setText(view, R.id.modified_time, Util.formatDateString(this.mContext, lFileInfo.ModifiedDate));
        ...
        if (lFileInfo.IsDir) {
            ...
            this.mFileIcon.setIcon(lFileInfo, lFileImage, lFileImageFrame);
        }
