...
public class SystemIntrActivity extends Activity {
	...
	private void init() {
		...
		String aboutUrl = this.m_iniFileIO.getIniString(this.userIni, "Software",
		...
		String tempUrl =  StringUtils.isUrl(Url+ aboutUrl,Url,null);
        ...
        this.finishBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
                SystemIntrActivity.this.finish();
                SystemIntrActivity.this.overridePendingTransition(R.anim.push_in, R.anim.push_out);
			}
		});
