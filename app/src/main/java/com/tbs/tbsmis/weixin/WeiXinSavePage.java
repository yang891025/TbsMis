...
/**
 * Created by TBS on 2015/11/26.
 */

public class WeiXinSavePage extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WeiXinSavePage.this.finish();
            }
        });
        this.menuBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WeiXinSavePage.this.changMorePopState2(v);
            }
        });
        ...
        this.lvNews.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // 点击头部、底部栏无效
                if (position == 0 || position == WeiXinSavePage.this.Userlist.size() + 1)
                    return;

                String sourceUrl = holder.url;
                // 跳转到新闻详情
                Intent intent = new Intent();
                intent.setClass(WeiXinSavePage.this,
                        BrowserActivity.class);
                intent.putExtra("tempUrl", sourceUrl);
                WeiXinSavePage.this.startActivity(intent);
            }
        });
        this.lvNews.setOnScrollListener(new OnScrollListener() {
            @Override
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                WeiXinSavePage.this.lvNews.onScrollStateChanged(view, scrollState);
                // 数据为空--不用继续下面代码了
                if (WeiXinSavePage.this.Userlist.isEmpty())
                    return;
                // 判断是否滚动到底部
                boolean scrollEnd = false;
                try {
                    if (view.getPositionForView(WeiXinSavePage.this.lvNews_footer) == view
                ...
                int lvDataState = StringUtils.toInt(WeiXinSavePage.this.lvNews.getTag());
                if (scrollEnd && lvDataState == UIHelper.LISTVIEW_DATA_MORE) {
                    WeiXinSavePage.this.lvNews.setTag(UIHelper.LISTVIEW_DATA_LOADING);
                    WeiXinSavePage.this.lvNews_foot_more
                            .setText(R.string.pull_to_refresh_refreshing_label);
                    WeiXinSavePage.this.lvNews_foot_progress.setVisibility(View.VISIBLE);
                    // ��ǰpageIndex
                    // int pageIndex = lvNewsSumData / AppContext.PAGE_SIZE;
                    WeiXinSavePage.this.initUserData(2);
                }
            }
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                WeiXinSavePage.this.lvNews.onScroll(view, firstVisibleItem, visibleItemCount,
                        totalItemCount);
            }
        });
        this.lvNews.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh() {
                WeiXinSavePage.this.initUserData(1);
            }
        });
        this.connect(0);
    }
    ...
    public void initUserData(int count) {
        ...
        if (this.Userlist.size() <= 0)
            this.lvNews_foot_more.setText("无最新信息");
        else
    ...
    private void popWindow2(View parent) {
        ...
        this.moreWindow2.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                WeiXinSavePage.this.isOpenPop = false;
            }
        });
    ...
    private void connect(int count) {
        WeiXinSavePage.GetAsyncTask task = new WeiXinSavePage.GetAsyncTask(count, this);
        task.execute();
    }
    ...
    class GetAsyncTask extends AsyncTask<Integer, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            WeiXinSavePage.this.startAnimation();
        }
        ...
        protected String doInBackground(Integer... params) {
            if (this.count == 1)
                WeiXinSavePage.this.clearData();
            WeiXinSavePage.this.initLocalData();
            return "ok";
        }
