 ...
 * @see LayoutParams#FLAG_FULLSCREEN
 */
public abstract class SystemUiHider {
	/**
	 * When this flag is set, the
	 * {@link LayoutParams#FLAG_LAYOUT_IN_SCREEN}
	 ...
	 */
	public static final int FLAG_HIDE_NAVIGATION = SystemUiHider.FLAG_FULLSCREEN | 0x4;
	 ...
	 */
	protected SystemUiHider.OnVisibilityChangeListener mOnVisibilityChangeListener = SystemUiHider.sDummyListener;
	...
	public void setOnVisibilityChangeListener(
			SystemUiHider.OnVisibilityChangeListener listener) {
		if (listener == null) {
			listener = SystemUiHider.sDummyListener;
		}
	 ...
	 */
	private static final SystemUiHider.OnVisibilityChangeListener sDummyListener = new SystemUiHider.OnVisibilityChangeListener() {
		@Override
