package com.tbs.tbsmis.Exam.adapter;
...
import com.tbs.tbsmis.Exam.AnalogyExaminationActivity;
import com.tbs.tbsmis.Exam.MyErrorQuestionActivity;
import com.tbs.tbsmis.Exam.bean.AnswerInfo;
import com.tbs.tbsmis.Exam.bean.ErrorQuestionInfo;
import com.tbs.tbsmis.Exam.bean.SaveQuestionInfo;
import com.tbs.tbsmis.Exam.database.DBManager;
import com.tbs.tbsmis.Exam.utils.ConstantUtil;
...
public class ExaminationSubmitAdapter extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup container,final int position) {
		...
		holder.questionType.setText(position+1+"、");
		...
		//判断题型
		if(dataItems.get(position).getQuestionType().equals("danxuan")){
			//单选题
			...
			holder.layoutA.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(dataItems.get(position).getCorrectAnswer().contains("A")){
						...
						holder.ivA.setImageResource(R.drawable.exam_practice_test_right);
						...
						holder.ivA.setImageResource(R.drawable.exam_practice_test_wrong);
			...
			holder.layoutB.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View arg0) {
								...
								if(dataItems.get(position).getCorrectAnswer().contains("B")){
									...
									holder.ivB.setImageResource(R.drawable.exam_practice_test_wrong);
			...
			holder.layoutC.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(dataItems.get(position).getCorrectAnswer().contains("C")){
						...
						holder.ivC.setImageResource(R.drawable.exam_practice_test_wrong);
			...
			holder.layoutD.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(dataItems.get(position).getCorrectAnswer().contains("D")){
						...
						holder.ivD.setImageResource(R.drawable.exam_practice_test_wrong);
			...
			holder.layoutE.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(dataItems.get(position).getCorrectAnswer().contains("E")){
						...
						holder.ivE.setImageResource(R.drawable.exam_practice_test_wrong);
		...
		}else if(dataItems.get(position).getQuestionType().equals("duoxuan")){
			//多选题
			...
			holder.layoutA.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					map.put(position, true);
					if(dataItems.get(position).getCorrectAnswer().contains("正确")){
						mContext.setCurrentView(position+1);
						holder.ivA.setImageResource(R.drawable.exam_practice_test_right);
						holder.tvA.setTextColor(Color.parseColor("#61bc31"));
						isCorrect=ConstantUtil.isCorrect;
						...
						errorQuestionInfo.setQuestionAnswer(dataItems.get(position).getCorrectAnswer());
						errorQuestionInfo.setIsRight(isCorrect);
						errorQuestionInfo.setQuestionSelect("正确");
						errorQuestionInfo.setAnalysis(dataItems.get(position).getAnalysis());
						errorQuestionInfo.setOptionType(dataItems.get(position).getOption_type());
						if(dataItems.get(position).getOption_type().equals("0")){
							errorQuestionInfo.setOptionA(dataItems.get(position).getOptionA());
						...
						if(dataItems.get(position).getCorrectAnswer().contains("正确")){
							holder.ivA.setImageResource(R.drawable.exam_practice_test_right);
							holder.tvA.setTextColor(Color.parseColor("#61bc31"));
						}else if(dataItems.get(position).getCorrectAnswer().contains("错误")){
							holder.ivB.setImageResource(R.drawable.exam_practice_test_right);
							holder.tvB.setTextColor(Color.parseColor("#61bc31"));
						}else if(dataItems.get(position).getCorrectAnswer().contains("C")){
							holder.ivC.setImageResource(R.drawable.exam_practice_test_right);
			...
			holder.layoutB.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View arg0) {
								...
								map.put(position, true);
								if(dataItems.get(position).getCorrectAnswer().contains("错误")){
									mContext.setCurrentView(position+1);
									holder.ivB.setImageResource(R.drawable.exam_practice_test_right);
									holder.tvB.setTextColor(Color.parseColor("#61bc31"));
									isCorrect=ConstantUtil.isCorrect;
									...
									errorQuestionInfo.setQuestionAnswer(dataItems.get(position).getCorrectAnswer());
									errorQuestionInfo.setIsRight(isCorrect);
									errorQuestionInfo.setQuestionSelect("错误");
									errorQuestionInfo.setAnalysis(dataItems.get(position).getAnalysis());
									errorQuestionInfo.setOptionType(dataItems.get(position).getOption_type());
									if(dataItems.get(position).getOption_type().equals("0")){
										errorQuestionInfo.setOptionA(dataItems.get(position).getOptionA());
...
//			holder.nextImage.setImageResource(R.drawable.exam__submit_finish);
//		}
	...
	class LinearOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
				if (mPosition == viewItems.size()) {
					//单选
					if(dataItems.get(mPosition1).getQuestionType().equals("danxuan")){
					...
					}else if(dataItems.get(mPosition1).getQuestionType().equals("duoxuan")){
						//判断多选时的点击
						if(!map.containsKey(mPosition1)){
