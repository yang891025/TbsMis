...
import com.tbs.tbsmis.Exam.adapter.ExaminationSubmitAdapter;
...
import com.tbs.tbsmis.Exam.utils.ViewPagerScroller;
import com.tbs.tbsmis.Exam.view.VoteSubmitViewPager;
...
public class AnalogyExaminationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.exam_practice_test);
	...
	private void loadData(){
		...
		if(bundle != null){
			List<AnswerInfo> datas = (List<AnswerInfo>) bundle.getSerializable("answerInfo");
			dataItems.addAll(datas);
			minute = Integer.parseInt(bundle.getString("e_time"));
		}
		for (int i = 0; i < dataItems.size(); i++) {
			//System.out.println(dataItems.get(i).toString());
			viewItems.add(getLayoutInflater().inflate(
					R.layout.exam__submit_viewpager_item, null));
		}
	...
	protected void showTimeOutDialog(final boolean flag, final String backtype) {
		...
		builder.setContentView(R.layout.exam_dialog);
	...
	protected void showSubmitDialog() {
		...
		builderSubmit.setContentView(R.layout.exam_dialog);
