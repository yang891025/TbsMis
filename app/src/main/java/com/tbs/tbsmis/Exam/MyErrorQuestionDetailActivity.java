...
public class MyErrorQuestionDetailActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.exam_error_question_detail);
		initView();
	}
