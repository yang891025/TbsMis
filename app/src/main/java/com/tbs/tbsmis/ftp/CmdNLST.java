...
public class CmdNLST extends CmdAbstractListing
{
	...
	public void run() {
		...
		if(errString != null) {
            ...
            this.myLog.l(Log.DEBUG, "NLST failed with: " + errString);
		} else {
            this.myLog.l(Log.DEBUG, "NLST completed OK");
		}
	...
	protected String makeLsString(File file) {
		   ...
		   lastNamePart.contains("/"))
		{
            ...
            CmdAbstractListing.staticLog.l(Log.DEBUG, "Filename: " + lastNamePart );
			return lastNamePart + "\r\n";
		}
	}
}
