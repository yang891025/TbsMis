...
public class CmdPORT extends FtpCmd
{
	...
	@Override
	public void run() {
        this.myLog.l(Log.DEBUG, "PORT running");
		...
		mainBlock: {
            ...
            this.sessionThread.onPort(inetAddr, port);
		}
		if(errString == null) {
            this.sessionThread.writeString("200 PORT OK\r\n");
            this.myLog.l(Log.DEBUG, "PORT completed");
		} else {
            this.myLog.l(Log.INFO, "PORT error: " + errString);
