...
public class UiUpdater {
	...
	public static void registerClient(Handler client) {
		if(!UiUpdater.clients.contains(client)) {
            UiUpdater.clients.add(client);
		}
	}
	
	public static void unregisterClient(Handler client) {
		while(UiUpdater.clients.contains(client)) {
            UiUpdater.clients.remove(client);
		}
	}
	...
	public static void updateClients() {
		...
		for (Handler client : UiUpdater.clients) {
