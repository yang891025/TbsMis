...
public class CmdPWD extends FtpCmd
{
    ...
    @Override
	public void run() {
        this.myLog.l(Log.DEBUG, "PWD executing");
        ...
        try {
            ...
            this.myLog.l(Log.ERROR, "PWD canonicalize");
            this.sessionThread.closeSocket(); // should cause thread termination
        }
        this.myLog.l(Log.DEBUG, "PWD complete");
    }
