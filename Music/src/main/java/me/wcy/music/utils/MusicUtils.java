...
public class MusicUtils {
    ...
    //专辑歌单详情接口
    public static final String URL_SPECIAL_INFO = HOST + "servlet/mobileApi/getSpecialInfo.cbs";
    //音乐详情接口
    public static final String URL_MUSIC_LIST = HOST + "servlet/mobileApi/getMusicList.cbs";
