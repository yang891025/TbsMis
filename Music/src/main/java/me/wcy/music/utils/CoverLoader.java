...
public class CoverLoader {
    ...
    public Bitmap loadRound(Bitmap bitmap) {
        return loadCoverByBitmap(bitmap, Type.ROUND);
    }

    public Bitmap loadBlur(Bitmap bitmap) {
        return loadCoverByBitmap(bitmap, Type.BLUR);
    }
    ...
    private Bitmap loadCoverByBitmap(Bitmap bitmap, Type type) {
        switch (type) {
            case ROUND:
                bitmap = ImageUtils.resizeImage(bitmap, roundLength, roundLength);
                return ImageUtils.createCircleImage(bitmap);
