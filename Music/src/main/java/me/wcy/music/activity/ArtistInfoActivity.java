...
public class ArtistInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = flater.inflate(R.layout.activity_artist_info, null);
        setContentView(view);
        svArtistInfo = (ScrollView)view.findViewById(R.id.sv_artist_info);
        llArtistInfoContainer = (LinearLayout)view.findViewById(R.id.ll_artist_info_container);
